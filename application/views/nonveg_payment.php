...
<table class="table">
  ...
  echo  $row->nonvegsnacks; 
   echo '<br/>';
 } 
?> </td>
<td>  <?php    foreach ($d as $row) {
  echo  $row->nonvegsnacks_Price; 
   echo '<br/>';
} ?>
</td>
<td> </td>
...
<div style="background-color:black;" >  
 ...
 <p class="text-right" >   <br>
  ...
  <h1>payment</h1>
    ...
    <p> Hey ! the total price of the veg is: <?php    foreach ($d as $row) {
...
<p> Hey ! the total price of the nonveg is: <?php    foreach ($d as $row) {
  echo  $row->maincourse_price; 
   echo '<br/>';
